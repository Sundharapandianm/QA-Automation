...
public class bottomRight {
	public static void main(String[] args) throws Exception {
      ...
      String inputPdf = "C:\\Users\\SundharaPandianM\\Workspace\\Edit10\\src\\main\\java\\30002275 1.pdf";                                                // your existing PDF
      ...
      img.setWidth(UnitValue.createPointValue(200));                                                                                             // width in points
      img.setHeight(UnitValue.createPointValue(100));                                                                                            // height in points
     ...
     // Calculate bottom-right position
      float margin = 30;
      float x = pageSize.getRight() - 200 - margin; // Right edge (mid number is height of the pic)
